...
#define NUM_BODIES (1024) // Number of small particles
...
#define RENDER_SCALE 1 // "Zoom" of images produced
...
#define STEP_COUNT 5 // Will automatically stop running after this many steps
